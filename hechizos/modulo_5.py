...
def mostrar_modulo_5(orientacion_nd=None):
    ...
    if not nds:
        contenido_nt = obtener_contenido_nd(df_contenido, "NT", modulo=5)
        if contenido_nt:
            label_nt = "<p style='font-family:Cinzel,serif; color:#9a9080; font-size:0.8rem; letter-spacing:0.05em; margin-bottom:0.5rem;'>ASÍ FUNCIONA TU SOCIALIZACIÓN</p>"
